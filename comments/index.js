    ...
    render() {
        ...
        return (
                <div className={`${className ? className: '' } card__list__item__comments`}>
                    ...
                    <CommentInput procurement_id={procurement_id} work_id={work_id} type_evaluation={type_evaluation} type_comment={type_comment} token={token} quality={quality} terms={terms} extended={extended} currentUser={currentUser} />
                </div>
        )
    }
}
